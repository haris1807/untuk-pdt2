...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4" style = "text-align:center;">Laporan Pengumpulan Zakat Fitrah</h1>
                        <div class="card mb-4">
            ...
            <?php
                $datauser = mysqli_query($koneksi, "select count(*) as total from bayarzakat");
                while($data= mysqli_fetch_array($datauser)){
                    $idm = $data['total'];
                }
                $datauser2 = mysqli_query($koneksi, "select sum(jumlah_tanggungan) as total from bayarzakat");
                while($data= mysqli_fetch_array($datauser2)){
                    $idm2 = $data['total'];
                }

                $datauser3 = mysqli_query($koneksi, "select sum(bayar_beras) as total from bayarzakat");
                while($data= mysqli_fetch_array($datauser3)){
                    $idm3 = $data['total'];
                }
                $datauser4 = mysqli_query($koneksi, "SELECT Sum((Replace(bayar_uang, 'Rp. ',''))) AS total FROM bayarzakat; ");
            ...
            <h2><b> Distribusi Ke Mustahik Warga</b></h2>
            <table  id="dataTable" width="100%" cellspacing="0">
            <tr>
            <td style = "width : 300px; ">Total Muzakki </td><td style = "width : 50px;">:</td><td id = "katm"><?=$idm?> orang</td>
            </tr>
            <tr>
            <td style = "width : 300px; ">Total Jiwa </td><td style = "width : 50px;">:</td><td id = "hakm"><?=$idm2?> jiwa</td>
            </tr>
            <tr>
            <td style = "width : 300px; ">Total Beras </td><td style = "width : 50px;">:</td><td id = "jumm"><?=$idm3?> Kg</td>
            </tr>
            <tr>
            <td style = "width : 300px; ">Total Uang </td><td style = "width : 50px;">:</td><td id = "totm">Rp. <?=$idm4?></td>
            </tr>
